...
yellow "Running ansible playbook config-spoke.yml"
ansible-playbook ${ansible_args} --extra-vars "${extra_vars}" -u pi config-spoke.yml $ansible_tags_arg

green "Finished running config-spoke.yml playbook"
